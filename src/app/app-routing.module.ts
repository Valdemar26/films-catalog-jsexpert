...
import { FilmsResolver } from './modules/films/resolvers/film.resolver';
import { AuthGuard } from './shared/guards/auth-guard.service';  // TODO use in some route

import { LoginComponent } from './shared/components/login/login.component';
import { RegistrationComponent } from './shared/components/registration/registration.component';

import { FavoriteFilmsComponent } from './modules/films/components/favorite-films/favorite-films.component';
...
const routes: Routes = [
  ...
  {
    path: 'films',
    loadChildren: () => import('./modules/films/films.module')
      .then(m => {
